<template>
    <div class="container">
        ...
        <svg v-bind="{id:'mini'+item.id}" viewBox="0 0 101 101" @click="saveSvg">
            ...
            <use transform="translate(0,0) scale(0.3)" v-bind="{href: '#i' + item.id + '_m0'}" />
            <use transform="translate(35,0) scale(0.3)" href="#border" />
            <use transform="translate(35,0) scale(0.3)" v-bind="{href: '#i' + item.id + '_m1'}" />
            <use transform="translate(70,0) scale(0.3)" href="#border" />
            <use transform="translate(70,0) scale(0.3)" v-bind="{href: '#i' + item.id + '_m2'}" />
            <use transform="translate(0,35) scale(0.3)" href="#border" />
            <use transform="translate(0,35) scale(0.3)" v-bind="{href: '#i' + item.id + '_m3'}" />
            <use transform="translate(35,35) scale(0.3)" href="#border" />
            <use transform="translate(35,35) scale(0.3)" v-bind="{href: '#i' + item.id + '_m4'}" />
            <use transform="translate(70,35) scale(0.3)" href="#border" />
            <use transform="translate(70,35) scale(0.3)" v-bind="{href: '#i' + item.id + '_m5'}" />
            <use transform="translate(0,70) scale(0.3)" href="#border" />
            <use transform="translate(0,70) scale(0.3)" v-bind="{href: '#i' + item.id + '_m6'}" />
            <use transform="translate(35,70) scale(0.3)" href="#border" />
            <use transform="translate(35,70) scale(0.3)" v-bind="{href: '#i' + item.id + '_m7'}" />
            <use transform="translate(70,70) scale(0.3)" href="#border" />
            <use transform="translate(70,70) scale(0.3)" v-bind="{href: '#i' + item.id + '_m8'}" />
        </svg>
    </div>
</template>
